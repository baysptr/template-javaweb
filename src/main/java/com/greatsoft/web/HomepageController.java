...
public class HomepageController {
        ...
        if(auth != null){
            ...
            if(principal != null && User.class.isAssignableFrom(principal.getClass())){
                ...
                if(ux != null || ux.getRole() != null || ux.getRole().getName() != null) {
                    ...
                    hasil.put("roleId", ux.getRole().getId());
                    hasil.put("userId", ux.getId());
                } else {
    ...
    @RequestMapping(value="/homepage/current-date", method= RequestMethod.DELETE)
    @ResponseStatus(HttpStatus.OK)
    public Date currentDate(@PathVariable String sessionid){
        return new Date();
    }
    ...
    @RequestMapping(value = "/homepage/session-id", method = RequestMethod.GET)
    @ResponseBody
    public Object sessionId(){
        return new ModelMap().addAttribute("id", appService.getSessionId());
    }
}
