...
import com.greatsoft.dao.MenuDao;
import com.greatsoft.dao.PermissionDao;
...
public class ConfigServiceImpl implements ConfigService {
    ...
    public Page<Menu> findAllMenu(Pageable pageable) {
        return menuDao.findAllOrderLevelOrder(pageable);
    }
...
//    }
    ...
    public Page<Menu> filterAllMenu(String search, Pageable pageable) {
        return menuDao.filter(search, pageable);
    }
}
