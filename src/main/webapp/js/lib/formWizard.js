...
var rcWizardDirective = {
    'rcWizard': function () {
        return {
            restrict: 'A',
//            controller: ['$scope', function ($scope, rcWizardService) {
            controller: function ($scope, rcWizardService) {
                    ...
                    $scope.api = rcWizardService;
                    console.log('$scope.api = ', $scope.api);
                    console.log('rcWizardService = ', rcWizardService);
                    $scope.$watch('api.message', handleBroadcast);
                    ...
                    this.loncat = function () {
                        wizardElement.bootstrapWizard('first');
                        wizardElement.bootstrapWizard('next');
                    };
                    this.loncat2 = function () {
                        wizardElement.bootstrapWizard('first');
                        wizardElement.bootstrapWizard('next');
                        wizardElement.bootstrapWizard('next');
                    };
                    this.loncat3 = function () {
                        wizardElement.bootstrapWizard('first');
                        wizardElement.bootstrapWizard('next');
                        wizardElement.bootstrapWizard('next');
                        wizardElement.bootstrapWizard('next');
                    };
                    this.loncat4 = function () {
                        wizardElement.bootstrapWizard('first');
                        wizardElement.bootstrapWizard('next');
                        wizardElement.bootstrapWizard('next');
                        wizardElement.bootstrapWizard('next');
                    ...
                    function handleBroadcast() {
                        console.log('$scope.api = ', $scope.api);
                        console.log('rcWizardService = ', rcWizardService);
//                $scope.message = 'Directive: ' + rcWizardService.message + rcWizardService.message;
                        if ($scope.api.message === 'loncat') {
                            loncat();
                        } else if ($scope.api.message === 'loncat2') {
                            loncat2();
                        } else if ($scope.api.message === 'loncat3') {
                            loncat3();
                        } else if ($scope.api.message === 'loncat4') {
                            fnloncat4();
                        } else {
                            fnFirst();
                        }
...
angular.module('rcWizard', ['ng'])
        .factory('rcWizardService', function () {
            var sharedService = {};
